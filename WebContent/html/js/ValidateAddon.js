...
//小数精度限制
jQuery.validator.addMethod("digitLimit", function(value, element,bit) {
	var reg = new RegExp("^(([1-9]\\d*)|\\d)(\\.\\d{1,"+bit+"})?$");
	return this.optional(element) || reg.test(value);
}, "精度{0}位小数");

//大于等于零
jQuery.validator.addMethod("geZero", function(value, element) {
	return this.optional(element) || (jQuery.isNumeric(value) && Number(value) >= 0);
}, "大于等于零");
...
jQuery.validator.addMethod("plateNumber", function(value, element) {
	return this.optional(element) || /^[\u4e00-\u9fa5]+[\dA-Za-z_]{6}$/.test(value);
}, "必须为中文加6个数字或者字母");
