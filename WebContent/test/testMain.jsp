...
<style type="text/css"> 
 ...
 .l-topmenu-logo{ color:#E7E7E7; padding-left:35px; line-height:40px;background:url('${resource}/images/logo.gif') no-repeat 10px 0px;}
...
<div id="topmenu" class="l-topmenu">
	...
	<div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; "> 
            ...
            <iframe frameborder="0" name="home" id="home" src="${ctx }/test/test.jsp"></iframe>
        </div> 
	    </div> 
	</div>
	<div  style="height:25px; line-height:25px; text-align:center;margin:0px;">
	           Copyright &copy; 2013-2014 All rights reserved.  
    </div>
</body>
</html>
