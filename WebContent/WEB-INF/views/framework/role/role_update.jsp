				...
				<table cellspacing="0" cellpadding="0" width="100%">
					...
					<tbody>
						<tr>
							...
							<td class="td-value"><input type="hidden" style="width:160px;" id="roleCode" name="roleCode" value="${item.roleCode }" maxlength="64" title="最多64位"/>${item.roleCode }</td>
						</tr>
						<tr>
